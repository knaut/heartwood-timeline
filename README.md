...
## Prior Art
Heartwood is based off a prior repo, HeartwoodVisualize, which made its way to my professional website. At the time, there were many unexplored avenues. How far can we go with an agentic tooling? Since I've already written this repo myself, it's a good A/B candidate.
